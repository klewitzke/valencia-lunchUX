...
if(isset($_GET['editId'])) {
	...
	do {
		...
		if(isset($_SESSION['Incomes'])){
			foreach($_SESSION['Incomes'] as $key_1=>$value_1) {
				if($value_1[0]==$guid || $_SESSION['adults'][$_SESSION['AdultNumber']][4] == 1) {
					$incomeReported = 1;
				}
			}
			if($incomeReported == 1) {
...
if(isset($_GET['editId']) && $cat1==1) {
	...
	foreach($_SESSION['Incomes'] as $key_1=>$value_1) {
		if($value_1[0]==$guid) {
			if($value_1[1]==1) {
				echo('<tr><td style="color:white;">$</td><td style="width:50%"><input class="opt1-wage" type="tel" name="opt1-wageamt[]" value="'.$value_1[2].'" style="text-align:center;margin:0;" placeholder="Amount" autocomplete="off" /></td><td style="width:50%"><select name="opt1-frequency[]" class="opt1-frequency" tabindex="3" ><option disabled>Frequency</option><option value="1"');
...
if(isset($_GET['editId']) && $cat2==1) {
	...
	foreach($_SESSION['Incomes'] as $key_1=>$value_1) {
		if($value_1[0]==$guid) {
			if($value_1[1]==2) {
				echo('<tr><td style="color:white;">$</td><td style="width:50%"><input class="opt2-wage" type="tel" name="opt2-wageamt[]" value="'.$value_1[2].'" style="text-align:center;margin:0;" placeholder="Amount" autocomplete="off" /></td><td style="width:50%"><select name="opt2-frequency[]" class="opt2-frequency" tabindex="3" ><option disabled>Frequency</option><option value="1"');
				if($value_1[3]==1) echo(' selected');
				echo('>Weekly</option><option value="2"');
				if($value_1[3]==2) echo(' selected');
				echo('>Every 2 Weeks</option><option value="3"');
...
if(isset($_GET['editId']) && $cat3==1) {
	...
	foreach($_SESSION['Incomes'] as $key_1=>$value_1) {
		if($value_1[0]==$guid) {
			if($value_1[1]==3) {
				echo('<tr><td style="color:white;">$</td><td style="width:50%"><input class="opt3-wage" type="tel" name="opt3-wageamt[]" value="'.$value_1[2].'" style="text-align:center;margin:0;" placeholder="Amount" autocomplete="off" /></td><td style="width:50%"><select name="opt3-frequency[]" class="opt3-frequency" tabindex="3" ><option disabled>Frequency</option><option value="1"');
				if($value_1[3]==1) echo(' selected');
				echo('>Weekly</option><option value="2"');
				if($value_1[3]==2) echo(' selected');
				echo('>Every 2 Weeks</option><option value="3"');
...
if(isset($_GET['editId']) && $cat4==1) {
	...
	foreach($_SESSION['Incomes'] as $key_1=>$value_1) {
		if($value_1[0]==$guid) {
			if($value_1[1]==4) {
				echo('<tr><td style="color:white;">$</td><td style="width:50%"><input class="opt4-wage" type="tel" name="opt4-wageamt[]" value="'.$value_1[2].'" style="text-align:center;margin:0;" placeholder="Amount" autocomplete="off" /></td><td style="width:50%"><select name="opt4-frequency[]" class="opt4-frequency" tabindex="3" ><option disabled>Frequency</option><option value="1"');
				if($value_1[3]==1) echo(' selected');
				echo('>Weekly</option><option value="2"');
				if($value_1[3]==2) echo(' selected');
				echo('>Every 2 Weeks</option><option value="3"');
