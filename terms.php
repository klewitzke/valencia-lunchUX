...
<div id="google_translate_element" style="max-width:200px;margin-left:auto;margin-right:auto;"></div><p>
<a id="change-lang" href="#" style="font-size:16px;">Change Language<br /></a>
<p>
<div id="main" style="font-size:18px;text-align:left;">
...
<br /><br />
Persons with disabilities who require alternative means of communication for program information (e.g. Braille, large print, audiotape, American Sign Language, etc.), should contact the Agency (State or local) where they applied for benefits. Individuals who are deaf, hard of hearing or have speech disabilities may contact USDA through the Federal Relay Service at <a href="tel:18008778339">(800) 877-8339</a>. Additionally, program information may be made available in languages other than English.
<br /><br />
To file a program complaint of discrimination, complete the USDA Program Discrimination Complaint Form, (AD-3027) found online at: <a href="http://www.ascr.usda.gov/complaint_filing_cust.html">http://www.ascr.usda.gov/complaint_filing_cust.html</a>, and at any USDA office, or write a letter addressed to USDA and provide in the letter all of the information requested in the form. To request a copy of the complaint form, call <a href="tel:18666329992">(866) 632-9992</a>. Submit your completed form or letter to USDA by:
<br /><br />
...
<br /><br />
<h4>Use of Information Statement</h4>
...
<button class="nav-prev" onClick="history.go(-1);return false;"><i class="fa fa-arrow-left"></i><br />Go<br />Back</button>
</body>
</html>